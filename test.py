...
a = 100 / pi #test @nobody
o.lp(['a',a],'test','100 over {}',[['pi',pi],],True)
b = ( a / pi) + ( 228 - 1337) # sex
o.lp(['b',b],'sex',' left({} over {} right) +  left(228 - 1337 right)',[['a',a],['pi',pi],],True)

c = sqrt(a**2 + b**2) # supersex
o.lp(['c',c],'supersex','sqrt{{{} ^ 2 + {} ^ 2}}',[['a',a],['b',b],],True)
o.nl()
a = a * pi
o.lp(['a',a],'','{} cdot {}',[['a',a],['pi',pi],],True)
b = 3*a - sqrt(a**3)
o.lp(['b',b],'','3 cdot {} - sqrt{{{} ^ 3}}',[['a',a],['a',a],],True)
c = sqrt(a**24+ b**2)
o.lp(['c',c],'','sqrt{{{} ^ 24 + {} ^ 2}}',[['a',a],['b',b],],True)

o.office.fin()
subprocess.run(["libreoffice", "--headless", "--convert-to", "pdf","/tmp/current.odt", "--outdir", "/tmp/"], check=True)
